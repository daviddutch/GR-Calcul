...
function createRow(rowId, i, suffix) {
    ...
    html += "<td colspan=\"2\" style=\"white-space: nowrap;\">&nbsp;<input novalidation=\"true\" type=\"text\" class=\"DateFormat Slotdate\" name=\"Slotdate" + suffix + "\" id=\"Slotdate" + suffix + "\" value=\"" + currentDate.asString() + "\" size=\"8\" /><a href=\"javascript:deleteRow('" + rowId + "');\" class=\"delete delRow\"></a></td>";
